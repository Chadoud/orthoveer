          ...
          <div className="prose prose-invert max-w-none">
            <section className="mb-8">
              ...
              <p className="text-gray-300 leading-relaxed mb-4">
                Orthoveer ("we," "our," or "us") is committed to protecting your
                privacy. This Privacy Policy explains how we collect, use,
                disclose, and safeguard your information when you visit our
                website located at Orthoveer.com (the "Website") or use our
                services.
              </p>
              <p className="text-gray-300 leading-relaxed mb-4">
                ...
                services. We are located at 190 Avenue du General de Gaulle,
            ...
            <section className="mb-8">
              ...
              <div className="mb-4">
                ...
                <p className="text-gray-300 leading-relaxed">
                  ...
                  hosting, data analysis, email delivery, and customer service.
                </p>
              </div>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-300 leading-relaxed mb-4">
                If you are located outside France and choose to provide
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-300 leading-relaxed mb-4">
                ...
                Regulation (GDPR). Orthoveer aims to take reasonable steps to
              ...
              <p className="text-gray-300 leading-relaxed mt-4">
                ...
                us using the information provided in the "Contact Us" section
                below.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-300 leading-relaxed">
                ...
                posted on this page. Your continued use of the Website after any
                changes to this Privacy Policy will constitute your acceptance
                of such changes.
              </p>
            </section>
            ...
            <section className="mt-12 pt-8 border-t border-white/10">
              ...
              <p className="text-gray-300 leading-relaxed mb-6">
                ...
                practices, or wish to exercise your rights regarding your
