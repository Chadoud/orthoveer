...
import image from "@assets/generated_images/maxform-l2-removebg-preview_1767043189567.png";

export default function MaxFormL2() {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="flex items-center justify-center">
                <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-2xl bg-white/5 p-8">
                  <img src={image} alt="MaxForm L2" className="w-full h-auto" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="space-y-6">
              ...
              {[
                ...
                "Minimal material waste with optimized stamping",
        ...
        <section className="py-20">
          <div className="container mx-auto px-6">
            <div className="max-w-3xl mx-auto">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4 font-heading text-center">Interested in MaxForm L2?</h2>
