...
export function MachinePlaceholder({ name, shortName, category, description, features }: MachinePlaceholderProps) {
      ...
      <main className="pt-20">
        ...
        <section className="py-20 bg-secondary/20">
          <div className="container mx-auto px-6">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-12 font-heading">Key Features</h2>
        ...
        <section className="py-20">
          <div className="container mx-auto px-6">
            <div className="max-w-3xl mx-auto">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4 font-heading text-center">Interested in {shortName}?</h2>
