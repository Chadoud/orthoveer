...
import image from "@assets/generated_images/maxprinter-p2-600x600-removebg-preview_1767043189565.png";

export default function MaxPrinterP2() {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-xl text-gray-400 mb-10 max-w-xl leading-relaxed">
                  Industrial 3D printer for production of dental models, splints, and surgical guides with exceptional detail and durability.
                </p>
              ...
              <div className="flex items-center justify-center">
                <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-2xl bg-white/5 p-8">
                  <img src={image} alt="MaxPrinter P2" className="w-full h-auto" />
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-20 bg-secondary/20">
          <div className="container mx-auto px-6">
            <div className="space-y-6">
              ...
              {[
                "High-resolution printing up to 50 microns",
                "Large build area for batch printing",
                "Fast print speeds without compromising quality",
        ...
        <section className="py-20">
          <div className="container mx-auto px-6">
            <div className="max-w-3xl mx-auto">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4 font-heading text-center">Interested in MaxPrinter P2?</h2>
